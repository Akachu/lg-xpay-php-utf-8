...
class XPayClient
{
	...
	private $INFO = array("LGD_TXID","LGD_AUTHCODE","LGD_MID","LGD_OID","LGD_TXNAME","LGD_PAYKEY","LGD_RESPCODE","LGD_RESPMSG");
	private $DEBUG = array("LGD_TXID","LGD_AUTHCODE","LGD_MID","LGD_TID","LGD_OID","LGD_PAYTYPE","LGD_PAYDATE","LGD_TXNAME","LGD_PAYKEY","LGD_RESPCODE","LGD_RESPMSG");
		...
		else 
		{
			...
			else 
			{
				...
				else 
				{
					...
					$this->log("Response Code=[".$this->response_code."], Msg=[".$this->response_array["LGD_RESPMSG"]."], Count=".$this->Response_Count(), LGD_LOG_INFO);
	...
	function Report_TX()
	{
		...
		$this->log("Report Response Code=[".$response_code."], Msg=[".$response_array["LGD_RESPMSG"]."]", LGD_LOG_INFO);
		return true;
	}
